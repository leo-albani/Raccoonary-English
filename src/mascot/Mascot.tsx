...
import greetingImg from '../assets/images/raccoon_greeting_1785474802664.jpg';
import happyImg from '../assets/images/raccoon_happy_1785474813911.jpg';
import thinkingImg from '../assets/images/raccoon_thinking_1785474825989.jpg';
import diggingImg from '../assets/images/raccoon_digging_1785474842124.jpg';
import sleepingImg from '../assets/images/raccoon_sleeping_1785474852544.jpg';
import readingImg from '../assets/images/raccoon_reading_1785474866046.jpg';
...
export const Mascot: React.FC<MascotProps> = ({
  ...
  const imgSrc = POSE_IMAGES[pose] || POSE_IMAGES.greeting;
